...
# Robert Cudmore
# 20191119, was part of Napari ShapeAnalysis plugin
# 20201027, merging in bImPy to do roi analysis
"""
...
class bRoiAnalysis:
	...
	def polygonAnalysis(self, slice, data):
		...
		try:
			...
			print('*** IndexError exception in bRoiAnalysis.polygonAnalysis() e:', e)
			raise
