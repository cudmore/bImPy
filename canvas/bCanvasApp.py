...
from canvas import bCanvas, bMenu
import bMotor
...
class bCanvasApp(QtWidgets.QMainWindow):
	...
	def userEvent(self, event):
		...
		if event == 'move stage right':
			...
			# set red crosshair
			print('   crosshair rect pos was:', self.myGraphicsView.myCrosshair.pos().x())
	...
	def load(self, thisFile = None):
		...
		if thisFile is not None:
			if os.path.isfile(thisFile):
				...
				print('Warning: bCanvasApp.load() did not find file:', thisFile)
