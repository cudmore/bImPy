...
**bImPy** is a multi-dimensional image viewer and annotation tool built with Python using PyQt for the interface. **bImPy** should be pronounced 'bimpee' but you can call it whatever you want.
...
On macOS Sierra (10.12) or earlier, you need to use a slighty older version of PyQt==5.13.0
...
# install napari first, makes life easire
pip install napari

# install requirements
pip install -r requirements-sierra.txt
